...
public class TestScoresView extends JFrame {
    ...
    public TestScoresView(TestScoresModel m) {
        ...
        highScoreButton.addActionListener(new HighestListener());
        aveScoreButton.addActionListener(new AverageListener());
    ...
    private class ModifyListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            // Attempt to replace student and display error or update fields
    ...
    private class HighestListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            JOptionPane.showMessageDialog(TestScoresView.this, "Highest score:\n" + model.getHighScore());
        }
    }
    
    // Responds to a click on the Class average button
    private class AverageListener implements ActionListener {
        
        public void actionPerformed(ActionEvent e) {
            JOptionPane.showMessageDialog(TestScoresView.this, "Class average:\n" + model.getClassAverage());
        }
    }
}
